...
#define CONFIG_LBM_RADIO_DIO0_PIN 26
#endif

#ifndef CONFIG_LBM_RADIO_DIO1_PIN
#define CONFIG_LBM_RADIO_DIO1_PIN 35
#endif

#ifndef CONFIG_LBM_RADIO_DIO2_PIN
#define CONFIG_LBM_RADIO_DIO2_PIN 34
#endif
...
static esp_err_t sx127x_spi_init(void)
{
    ...
    ret = spi_bus_initialize(CONFIG_LBM_SPI_HOST, &buscfg, SPI_DMA_CH_AUTO);
    if (ret != ESP_OK && ret != ESP_ERR_INVALID_STATE) {
